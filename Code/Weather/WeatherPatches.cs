...
internal class WeatherPatches
{
	...
	/// <summary>
	/// Patches <c>Game1.getWeatherModificationsForDate</c> to make sure the weather is sunny for the Twilight Festival.
	/// </summary>
	...
	{
		if (date is not null && date.Season == Season.Fall && date.DayOfMonth == 26)
			__result = "Sun";
	}
}
